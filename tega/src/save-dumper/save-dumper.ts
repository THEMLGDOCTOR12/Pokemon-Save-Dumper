import { BTN_START, LCDCF_BGON, LCDCF_OBJON, LCDCF_ON, P1F_GET_BTN, RAM, RAMBANKSET, rLCDC, rLY, rP1, rSB, rSC, SCF_SOURCE, SCF_START } from "../hardware-inc";
...
export const dumpBytesOverSerial = fn('dumpBytesOverSerial', () => [
  ...
  LD(Reg16.HL, u16(0xA000)),
  // Setup the Memory Bank Number
  LD(Reg8.L, u8(0x00)),
